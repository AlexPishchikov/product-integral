...
def draw_plot(function_params, plot_type):
    os.system(f"./run_solver.sh {function_params.type} {plot_type.to_string()} {function_params.n} {function_params.c} {function_params.a} {function_params.b} {function_params.h} {function_params.max}")
...
class MainWindow(QMainWindow):
    ...
    def draw_plot(self):
        self.function_params.type = '"' + ("c*x^n" if self.power_function_radio_button.isChecked() else "e^(n*x + c)").replace(' ', '') + '"'
